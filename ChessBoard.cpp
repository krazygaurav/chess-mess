...
//initializes the board to the standard chess opening state with indexing as shown in the figure.
//This method should use the constructors of the appropriate pieces, and call placePiece below to place the newly constructed pieces in the right position.
...
Legality is defined based on the rules described above. If the move is legal, it executes the move, 
changing the value of the board as needed. The method returns true if the move was executed, and false otherwise.
*/
